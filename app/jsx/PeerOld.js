...
function Peer(options) {
    ...
    this.pc = new PeerConnection(options.connectionConfig, options.connectionConstraints);
    ...
    this.pc.on('error', function(err){console.log("PCERROR", err)});
    ...
    if (message.type === 'offer') {
       ...
       // delete message.payload.nick;
        this.pc.handleOffer(message.payload, function (err) {
            console.log("HANDLING OFFER", message.payload);
            if (err) {
                console.log(err);
                return;
            }
       ...
       console.log("RECEIVED ANSWER", message.payload);
        ...
        console.log("RECEIVED CANDIDATE", message.payload);
...
Peer.prototype.onIceCandidate = function (candidate) {
    ...
    if (candidate) {
        var pcConfig = this.connectionConfig;
...
Peer.prototype.start = function () {
   ...
   // console.log("starting PEER");
    this.pc.offer(this.receiveMedia, function (err, sessionDescription) {
        ...
        console.log("starting PEER", sessionDescription);
    });
};
...
Peer.prototype.logger = function(message){
    console.log(message);
}
